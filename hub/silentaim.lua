...
if magnitude < nearestmagnitude and magnitude <= _G.fov then
nearestenemy = v
...
if UserInputService:IsMouseButtonPressed(0) and _G.enabled and Players.LocalPlayer.Character and Players.LocalPlayer.Character:FindFirstChild("Humanoid") and Players.LocalPlayer.Character.Humanoid.Health > 0 then
